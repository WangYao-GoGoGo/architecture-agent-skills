...
Knowledge cards are reusable architecture concepts that skills can reference without duplicating long explanations.

## Structure

- `principles/`: cross-cutting design principles.
- `patterns/`: design and architecture pattern cards.
- `smells/`: code, schema, boundary, and architecture smell cards.
- `refactoring/`: behavior-preserving change moves.
...
Knowledge cards should describe durable concepts. Skills should describe executable workflows.
