...
- Keep `my.*` platform API calls behind adapters when the behavior matters to tests, portability, or error handling.
...
- Design for Alipay's specific review process, package size limits, and subpackage loading.
...
- Representative pages can be tested or reasoned about without invoking real Alipay APIs.
