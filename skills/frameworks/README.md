...
Framework skills review architecture decisions that depend on framework lifecycle, conventions, generated code, ORM behavior, migration tooling, middleware, or runtime framework behavior.

Current framework review skills:

- `framework-boundary-review`
- `orm-boundary-review`

Framework-specific skill packs currently present here:
